...
Desktop starts the actual Host after preparing the profile in place, without booting a separate health-check backend. Package mutations retain dependency validation, approved lifecycle builds, runtime identity checks, and locking. The [package transaction recovery decision](../bug-fix/2026-09-21-desktop-package-lock-recovery.md) owns exception rollback and crash recovery; Host failures after package commit retain the committed graph.
