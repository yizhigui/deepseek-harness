...
export const en = {
  ...
  pluginFailureTitle: 'Desktop plugin change failed',
  pluginProfileRestored: 'The Desktop profile was restored to its previous state, so the application is still available. The plugin was not installed.',
...
export const zh = {
  ...
  pluginFailureTitle: '桌面插件变更失败',
  pluginProfileRestored: '桌面配置已恢复到变更前的状态，应用仍可正常使用。该插件未安装。',
